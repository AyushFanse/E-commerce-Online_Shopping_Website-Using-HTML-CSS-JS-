...
const getImg=(()=>{
    ...
    const createData = `<div class="col-md-6 d-flex justify-content-center"> 
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="p-2" id="rom"><span class="col-md-3 d-flex justify-content-start">RAM: ${product[x].ram}</span><span class="col-md-3 d-flex justify-content-start">ROM: ${product[x].rom}</span></p>
